...
The second line includes the widget in the page.
We then tell the user to click the button below to submit the form, and include
a submit button in the last line.

The layout is analogous for the second form on the page, which allows
the user to retrieve saved tax data. Here is the second form isolated from 
the rest of the method for clarity:  
